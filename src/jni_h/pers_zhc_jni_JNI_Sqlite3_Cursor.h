...
#include <jni.h>
/* Header for class pers_zhc_jni_JNI_Sqlite3_Cursor */

#ifndef _Included_pers_zhc_jni_JNI_Sqlite3_Cursor
#define _Included_pers_zhc_jni_JNI_Sqlite3_Cursor
#ifdef __cplusplus
extern "C" {
#endif
/*
 * Class:     pers_zhc_jni_JNI_Sqlite3_Cursor
 * Method:    reset
 * Signature: (J)V
 */
