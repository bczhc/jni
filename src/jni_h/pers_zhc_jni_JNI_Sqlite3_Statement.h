...
#include <jni.h>
/* Header for class pers_zhc_jni_JNI_Sqlite3_Statement */

#ifndef _Included_pers_zhc_jni_JNI_Sqlite3_Statement
#define _Included_pers_zhc_jni_JNI_Sqlite3_Statement
#ifdef __cplusplus
extern "C" {
#endif
/*
